        ...
        <Card>
            <Card.Body>
                ...
                <Row className="text-center mt-2 py-2">
                    <Col lg={4}>
                        <i className="mdi mdi-trending-up text-success mt-3 h3" />
                    ...
                    <Col lg={4}>
                        <i className="mdi mdi-trending-down text-primary mt-3 h3" />
                        <h3 className="fw-normal">
                            <span>26%</span>
                        </h3>
                    ...
                    <Col lg={4}>
                        <i className="mdi mdi-trending-down text-danger mt-3 h3" />
                        <h3 className="fw-normal">
                            <span>10%</span>
                        </h3>
